...
class quadtree {
// protected:
// WAS ORIGINALLY PROTECTED I MADE IT PUBLIC
public:
    /**
...
public:
    ...
    void renderHelperFunction(PNG& image, quadtree::Node* node) const;
    ...
    void pruneHelperFunction(Node *& subtree, int tol);
    ...
    // HELPER FUNCTION: 
    int pruneSizeHelperFunction(Node * tree, int tol) const;
...
private:
    ...
    // HELPER FUNCTION BELOW:
    void clearHelperFunction(Node *subtree);
    void clear();
    ...
    void copyHelperFunction(Node* &subtree, const Node* otherSubtree);
